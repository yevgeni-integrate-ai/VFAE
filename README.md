...
We can see that the model becomes significantly less biased. Unfortunately, some information regarding race does leak through. This is primarily due to the limited feature set and imbalanced nature of the dataset.
